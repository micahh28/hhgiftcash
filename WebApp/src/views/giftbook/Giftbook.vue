      ...
      <van-tabs v-model="activeName" animated>
        <van-tab title="人情礼簿" name="friendship">
          ...
          <div class="app-content">
            ...
            <div>
              <van-row type="flex">
                <van-col span="12" class="book" @click="onBookClick(book.id)" v-for="book in friendshipbooks"
                  :key="book.id">
                  <h4>{{ book.name }}</h4>
                  <br />
        ...
        <van-tab title="账簿" name="bill">
          ...
          <div class="app-content">
            ...
            <div>
              <van-row type="flex">
                <van-col span="12" class="bookgreen" @click="onBookClick(book.id)" v-for="book in billbooks"
                  :key="book.id">
                  <h4>{{ book.name }}</h4>
                  <br />
                  <h6>共{{ book.count }}笔</h6>
